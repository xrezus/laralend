...
<head>
    <meta charset="utf-8"/>
    <title>Lending for Laravel</title>
...
<nav class="navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark">
    <div class="container">
        ...
        <a class="navbar-brand logo" href="#">
            <img src="{{ asset('images/logo-dark.png') }}" alt="" class="" height="21">
        </a>
...
<section class="hero-4-bg position-relative d-flex align-items-center bg-light" id="home">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h1 class="text-dark hero-4-title font-weight-light line-height-1_4 mb-4">Grow With Your Business & Be
                    <span class="font-weight-normal">The Best Entrepreneur.</span></h1>
                <p class="text-muted">At vero eos et accusamus et iusto odio dignissimos ducimus a qui blanditiis
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8">
                <div class="title text-center mb-5">
                    ...
                    <p class="text-muted">Maecenas tempus tellus eget condimentum rhoncus sem quam semper libero
...
<section class="section bg-light" id="about">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <h2 class="font-weight-light line-height-1_6 text-dark mb-4">Passionate About Creating Templates For
                    Setup</h2>
            </div>
            <div class="col-md-7 offset-md-1">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="text-muted font-weight-light">At vero eos accusamus iusto odio dignissim ducimus a
                            blandi praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias
                            excepturi sit occaecati cupiditate provident similique sunt.</p>
                    </div>
                    <div class="col-md-6">
                        <h6 class="text-dark font-weight-light f-20 mb-3">Our Vision</h6>
                        <p class="text-muted font-weight-light">Temporibus autem quibusdam et aut officiis debitis that
                            aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non
                            recusandae at Itaque earum rerum hic tenetur sapiente.</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="section" id="features">
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-md-5" style="background: url({{ asset('images/features/features-bg.png') }}) center center">
            ...
            <div class="col-md-6 offset-md-1">
                <div class="features-box mt-5 mt-sm-0 mb-4">
                    ...
                    <p class="text-muted mb-3 f-15">Et harum quidem rerum facilise expedita distinctio nam libero
                        tempore cum soluta nobis as eligendi optio cumque nihil quis nostrum exercitationem impedit
                        minus omnis repellendus.</p>
        ...
        <div class="row align-items-center mt-5">
            <div class="col-md-6">
                <div class="features-box mb-4">
                    ...
                    <p class="text-muted mb-3 f-15">Sed perspiciatis unde omnis natus error voluptatem accusantium
                        doloremque laudantium totam rem aperiam eaque ipsa quae ab illo excepturi sint occaecati
                        cupiditate architecto.</p>
                    <a href="#" class="f-16 text-warning">Read More <span class="right-icon ml-2">&#8594;</span></a>
                </div>
            </div>
            <div class="col-md-5 offset-md-1 mt-5 mt-sm-0" style="background: url({{ asset('images/features/features-bg.png') }}) center center">
                <div class="features-img">
                    <img src="{{ asset('images/features/img-2.png') }}" alt="" class="img-fluid d-block mx-auto">
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center mt-5">
            <div class="col-md-5" style="background: url({{ asset('images/features/features-bg.png') }}) center center">
                <div class="features-img">
                    <img src="{{ asset('images/features/img-3.png') }}" alt="" class="img-fluid d-block mx-auto">
                </div>
            </div>
            <div class="col-md-6 offset-md-1">
                <div class="features-box mt-5 mt-sm-0 mb-4">
                    ...
                    <p class="text-muted mb-3 f-15">At vero eos accusamus iusto odio soluta nobis est eligendi optio
                        dignissimos ducimus qui blanditiis praesentium as voluptatum deleniti corrupti quos dolores
                        molestias occaecati.</p>
                    <a href="#" class="f-16 text-warning">Read More <span class="right-icon ml-2">&#8594;</span></a>
                </div>
            </div>
        </div>
...
<!-- Counter Start -->
<section class="section counter-bg" style="background: url({{ asset('images/counter-bg-1.jpg') }}) center center">
...
<section class="section bg-light" id="clients">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4">
                <h3 class="font-weight-normal mt-3 line-height-1_4">Some Words From Our
                    <span class="font-weight-medium text-warning">Happy Clients </span></h3>
                <div class="testi-border my-4"></div>
                <p class="text-muted">Itaque earum rerum tenetur a sapiente delectus ut aut reiciendis voluptatibus
                ...
                <div class="owl-carousel owl-theme">
                    <div class="item">
                        <div class="testi-content m-3 position-relative">
                            <div class="testi-box p-4">
                                ...
                                <p class="text-muted position-relative mb-0 f-14"><span class="f-20 mr-1">"</span> Sed
                                    ut perspiciatis unde omnis at iste natus error a voluptatem accusantium doloremque
                                    totam. <span class="f-16">"</span></p>
                            </div>
                            <div class="testi-user mt-4">
                                <div class="media align-items-center">
                                    <img src="{{ asset('images/user/img-1.jpg') }}" alt="" class="mr-3 img-fluid d-block rounded-circle">
                    ...
                    <div class="item">
                        <div class="testi-content m-3 position-relative">
                            ...
                            <div class="testi-user mt-4">
                                <div class="media align-items-center">
                                    <img src="{{ asset('images/user/img-2.jpg') }}" alt="" class="mr-3 img-fluid d-block rounded-circle">
                                    <div class="media-body">
                                        <h6 class="mb-0 text-dark f-15">Roberta Guevara</h6>
                                        <p class="text-muted mb-0 f-14">Web Developer</p>
                                    </div>
                    ...
                    <div class="item">
                        <div class="testi-content m-3 position-relative">
                            ...
                            <div class="testi-user mt-4">
                                <div class="media align-items-center">
                                    <img src="{{ asset('images/user/img-3.jpg') }}" alt="" class="mr-3 img-fluid d-block rounded-circle">
                                    <div class="media-body">
                                        <h6 class="mb-0 text-dark f-15">Roberta Guevara</h6>
                                        <p class="text-muted mb-0 f-14">Web Developer</p>
                                    </div>
                    ...
                    <div class="item">
                        <div class="testi-content m-3 position-relative">
                            ...
                            <div class="testi-user mt-4">
                                <div class="media align-items-center">
                                    <img src="{{ asset('images/user/img-4.jpg') }}" alt="" class="mr-3 img-fluid d-block rounded-circle">
                                    <div class="media-body">
                                        <h6 class="mb-0 text-dark f-15">Roberta Guevara</h6>
                                        <p class="text-muted mb-0 f-14">Web Developer</p>
                                    </div>
                    ...
                    <div class="item">
                        <div class="testi-content m-3 position-relative">
                            ...
                            <div class="testi-user mt-4">
                                <div class="media align-items-center">
                                    <img src="{{ asset('images/user/img-5.jpg') }}" alt="" class="mr-3 img-fluid d-block rounded-circle">
                                    <div class="media-body">
                                        <h6 class="mb-0 text-dark f-15">Roberta Guevara</h6>
                                        <p class="text-muted mb-0 f-14">Web Developer</p>
                                    </div>
            ...
            <div class="col-lg-7 offset-lg-1">
                <div class="custom-form mt-4 mt-lg-0">
                    ...
                    <form method="post" action="{{ route('order') }}" name="contact-form" id="contact-form">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <button type="submit" id="submit" name="send" class="btn btn-warning">Send Message
                                    <i class="mdi mdi-telegram ml-2"></i></button>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="subscribe-icon">
                            <img src="{{ asset('images/icon/1.png') }}" alt="" class="img-fluid mx-auto d-block">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="subscribe-icon">
                            <img src="{{ asset('images/icon/2.png') }}" alt="" class="img-fluid mx-auto d-block">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="">
                            <img src="{{ asset('images/icon/3.png') }}" alt="" class="img-fluid mx-auto d-block">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="text-center mt-5 mb-4">
                    <h6 class="text-muted font-weight-normal">Subscribe To Our Newsletter For New Content,
                        <span class="d-block mt-2">Update And Giveaways!</span></h6>
                </div>
...
<section class="footer">
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <div class="mb-4">
                    <a href="#"><img src="{{ asset('images/logo-dark.png') }}" alt="" class="logo-dark" height="26"/></a>
        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <div class="text-center text-muted">
                    <p class="mb-0 f-15">2020 © Design by Laravel</p>
                </div>
            </div>
        </div>
    </div>
