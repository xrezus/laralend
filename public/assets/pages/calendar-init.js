$(document).ready(function () {
    ...
    $("#external-events div.external-event").each(function () {
        ...
        $(this).data("eventObject", e), $(this).draggable({zIndex: 999, revert: !0, revertDuration: 0})
    });
    var n = $("#calendar").fullCalendar({
        ...
        defaultView: "month",
        axisFormat: "h:mm",
        columnFormat: {month: "ddd", week: "ddd d", day: "dddd M/d", agendaDay: "dddd d"},
        titleFormat: {month: "MMMM YYYY", week: "MMMM YYYY", day: "MMMM YYYY"},
        allDaySlot: !1,
        locale: 'ru',
        selectHelper: !0,
        select: function (e, t, a) {
            var l = prompt("Добавить событие:");
            l && n.fullCalendar("renderEvent", {title: l, start: e, end: t, allDay: a}, !0), n.fullCalendar("unselect")
        },
        droppable: !0,
        drop: function (e, t) {
            var a = $(this).data("eventObject"), l = $.extend({}, a);
            l.start = e, l.allDay = t, $("#calendar").fullCalendar("renderEvent", l, !0), $("#drop-remove").is(":checked") && $(this).remove()
        },
        events: [{title: "All Day Event", start: new Date(l, a, 1)}, {
            id: 999,
        ...
        }, {title: "Meeting", start: new Date(l, a, t, 10, 30), allDay: !1, className: "bg-danger"}, {
            title: "Lunch",
